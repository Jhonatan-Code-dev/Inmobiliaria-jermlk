...
export type DashboardSectionId = 'overview' | 'expenses' | 'clients' | 'inmuebles' | 'alquileres' | 'staff' | 'cargos' | 'pagos' | 'servicios' | 'tickets' | 'asistencia' | 'supervision_asistencia' | 'cola_trabajo';
