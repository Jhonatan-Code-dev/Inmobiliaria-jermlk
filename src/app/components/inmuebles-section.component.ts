      ...
      <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-sm overflow-hidden transition-colors">
        @if (isLoadingList()) {
              ...
              <tbody class="divide-y divide-slate-100 dark:divide-slate-800 transition-colors">
                @for (item of inmuebles(); track item.id) {
                  <tr class="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all">
                    ...
                    <td class="px-8 py-6">
                      <p class="text-xs font-bold text-slate-700 dark:text-slate-300 truncate max-w-[200px] transition-colors">{{ item.direccion }}</p>
          ...
          <div class="p-20 text-center flex flex-col items-center">
            ...
            <p class="text-slate-500 dark:text-slate-400 max-w-xs mt-2 font-medium">No se encontraron resultados para tu búsqueda. ¡Registra tu primer inmueble ahora!</p>
          </div>
        }
      </div>
            ...
            <div class="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-8">
               ...
               <div class="grid grid-cols-2 gap-4">
                  <div class="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
                    <p class="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Unidades Registradas</p>
                    <p class="text-3xl font-black text-slate-900 dark:text-white mt-1">{{ selectedInmueble()?.unidades?.length || 0 }}</p>
                  </div>
                  <div class="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
