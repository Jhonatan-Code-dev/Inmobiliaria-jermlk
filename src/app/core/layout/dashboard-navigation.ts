...
export type DashboardSectionId = 'overview' | 'expenses' | 'clients' | 'inmuebles' | 'alquileres' | 'staff' | 'cargos' | 'pagos' | 'servicios' | 'tickets' | 'asistencia' | 'supervision_asistencia' | 'cola_trabajo' | 'reportes' | 'citas' | 'reclamaciones' | 'manual_usuario';
...
export const DASHBOARD_NAVIGATION_ITEMS: readonly DashboardNavItem[] = [
  ...
  {
    id: 'supervision_asistencia',
    path: APP_ROUTE_SEGMENTS.supervision_asistencia,
    label: 'RRHH Asistencia',
    icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 112-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'
  },
  {
    id: 'reportes',
